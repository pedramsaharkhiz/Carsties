...
namespace AuctionService.Data
{
    ...
    {
        public static void InitDb(WebApplication app, ILoggerFactory loggerFactory)
        {
            using var scope = app.Services.CreateScope();
            var logger = loggerFactory.CreateLogger<DbInitializer>();
            SeedData(scope.ServiceProvider.GetService<AuctionDbContext>(), logger);
        }

        private static void SeedData(AuctionDbContext context, ILogger<DbInitializer> logger)
        {
